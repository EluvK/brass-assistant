...
def main():
    ...
    ap.add_argument("--max-candidate-batch", type=int, default=65536,
                    help="maximum padded candidate rows per GPU batch; GPU memory "
                         "scales roughly linearly with this, so lower it first if "
                         "a run does not fit")
