...
def load_imitation_shard(
    path: str,
) -> List[Tuple[int, int, Tuple[float, float, float, float], Tuple[float, float, float, float], Tuple[float, float, float, float], Tuple[float, float], bytes, str]]: ...


def dump_imitation_shard(
    path: str,
    records: Sequence[Tuple[int, int, Sequence[float], Sequence[float], Sequence[float], Sequence[float], bytes, str]],
) -> None: ...
