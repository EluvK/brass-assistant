...
pub use crate::gameplay::actions::{
    ...
    coal_options_for_connection, coal_source_options, discard_card,
    enumerate_double_rail_candidates, execute_build, execute_develop, execute_loan,
    execute_network, execute_network_double, execute_pass, execute_scout,
